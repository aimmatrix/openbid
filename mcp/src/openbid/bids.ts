// mcp/src/openbid/bids.ts
// Sample bids per scene. Used by simulate_auction so the MCP server can run
// end-to-end without needing LLM/Tavily keys.
...
export const bidsKitchen: Bid[] = [
  {
    ...
    bid: 5.4,
    reasoning:
      "Warm kitchen at sunrise with an empty mug is textbook intent for specialty coffee. Visual aesthetic matches our brand. Bidding aggressively.",
    target_slot: "slot_01",
    research_snippets: [
  ...
  },
  {
    ...
    bid: 3.1,
    reasoning:
      "Loose fit. The protagonist's casual look could merchandise our line, but the mug slot is wrong inventory for apparel.",
    target_slot: "slot_02",
    research_snippets: [
  ...
  },
  {
    ...
    bid: 2.9,
    reasoning:
      "Cereal box slot is on-target inventory. Morning daypart fits. Mid-confidence bid.",
    target_slot: "slot_02",
    research_snippets: [
...
export const bidsPark: Bid[] = [
  {
    ...
    bid: 8.4,
    reasoning:
      "Outdoor leisure scene with picnic drinks is high-intent for lager. Bidding strong to win the slot.",
    target_slot: "slot_03",
    research_snippets: [
  ...
  },
  {
    ...
    bid: 3.2,
    reasoning:
      "Afternoon outdoor scene is off-daypart for coffee. Low bid as a cover for portfolio diversity.",
    target_slot: "slot_03",
    research_snippets: [
  ...
  },
  {
    ...
    bid: 4.6,
    reasoning:
      "Outdoor casual context fits our Q4 outdoor/active push. T-shirt slot is exactly the inventory we want.",
    target_slot: "slot_04",
    research_snippets: [
...
export function sampleBidsFor(scene_id: string): Bid[] {
  if (scene_id === "scene_park_afternoon") return bidsPark;
  return bidsKitchen;
}
